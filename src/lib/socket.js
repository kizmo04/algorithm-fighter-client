...
export function sendAcceptCombatMessage(dispatch, actionCreator, {combatRoomKey, guestUser}) {
  socket.emit('accept combat', {combatRoomKey, guestUser});
  dispatch(actionCreator({combatRoomKey}));
}

function findingGuestFailureSocket(dispatch, actionCreator) {
