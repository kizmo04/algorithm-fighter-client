    ...
    return (
      <div className="modal-card">
        <header className="modal-card-head">
          <p className="modal-card-title subtitle is-small is-spaced">
            {appStage === APP_STAGE_MATCH_END ? "결과" : "매칭 중"}
          </p>
          <button
          ...
          appStage === APP_STAGE_PENDING_MATCH_ACCEPTANCE ? (
              ...
              <div className="column is-two-third match-modal invitation-message-container">
                <figure className="image is-64x64 user-profile-image match-modal">
                  <img
                    ...
                    src={matchPartner.profileImageUrl}
                    alt=""
                  />
                </figure>
                <span className="subtitle is-small match-modal-message invitation">
                  {matchPartner.userName}의 결투신청
                </span>
              </div>
              <div className="column is-one-third">
                <button
                  className="button is-small is-fullwidth is-danger invitaion-button"
                  onClick={this.handleAcceptButtonClick}
                >
                  수락
                </button>
                <button
                  className="button is-small is-fullwidth is-white invitaion-button"
            ...
            <div className="columns is-multiline match-modal match-end">
              <div className="column is-half match-modal match-end">
                <div className="subtitle is-danger is-small match-modal match-end has-text-danger">
                  {matchResult.winner.user_name} Win!
                </div>
              </div>
              <div className="column is-half match-modal match-end">
                <div className="subtitle is-small match-modal match-end loser-title">
                  {matchResult.loser.user_name} Lose!
                </div>
              </div>
              <div className="column is-half match-modal match-end">
                <Link
                  onClick={this.handleOnCloseButtonClick}
                  className="button is-fullwidth is-small is-white match-modal match-end"
                  to="/"
                >
                  메인으로
                </Link>
              ...
              <div className="column is-half match-modal match-end">
                <Link
                  onClick={this.handleOnCloseButtonClick}
                  className="button is-fullwidth is-small is-danger match-modal match-end"
